        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-x-4 gap-y-3">
              ...
              <li><Link to="/scheduled-rides" className="text-gray-400 hover:text-brand-yellow hover:translate-x-1 inline-flex items-center transition-all text-sm group"><ChevronRight className="w-3 h-3 mr-1 opacity-0 group-hover:opacity-100 transition-opacity" /> Scheduled Rides</Link></li>
